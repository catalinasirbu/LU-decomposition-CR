...
HLS_SOURCES = ../../../../testbench.cpp ../../../../decompose.cpp
...
$(ObjDir)/decompose.o: ../../../../decompose.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../decompose.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/decompose.d
