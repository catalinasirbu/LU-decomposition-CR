...
extern "C" __attribute__((sdx_kernel("decompose", 0))) void decompose(float m[5000][5000], float l[5000][5000], float u[5000][5000], int size);
# 2 "decompose.cpp" 2

extern "C" {

__attribute__((sdx_kernel("decompose", 0))) void decompose(float m[5000][5000], float l[5000][5000], float u[5000][5000], int size) {
#line 18 "C:/Users/catal/Vivado/LU-decomposition/LU-decomposition/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=decompose
# 5 "decompose.cpp"
...
#pragma HLS ARRAY_PARTITION variable=u block factor=8 dim=2
 ...
 init_lu:
    for (int i = 0; i < size; i++) {
        VITIS_LOOP_18_1: for (int j = 0; j < size; j++) {
